...
class XiuxianDateManage:
    ...
    def realm_top(self):
        ...
        ORDER BY CASE
        WHEN level = '渡劫境圆满' THEN '1'
        WHEN level = '渡劫境中期' THEN '2'
        WHEN level = '渡劫境初期' THEN '3'
        WHEN level = '大乘境圆满' THEN '4'
        WHEN level = '大乘境中期' THEN '5'
        WHEN level = '大乘境初期' THEN '6'
        WHEN level = '合体境圆满' THEN '7'
        WHEN level = '合体境中期' THEN '8'
        WHEN level = '合体境初期' THEN '9'
